...
<div class="modal fade" id="myModal<?php echo $invoice;?>">
	<div class="modal-dialog">
		<div class="modal-content">
			<!-- Modal Header -->
			<div class="modal-header">
			...
			<div class="modal-body">
				...
				<div class="row">	
					...
					<div class="col-md-6">
						...
						<p><strong>Due Amount: </strong><?php echo $row['total_amount']-$row['pay_amount']; ?></p>
					</div>
				</div>
				<hr/>
				...
				<div class="modal-footer">
				  ...
				  <button type="button" class="btn btn-primary" onClick="return myModal();" >Print Invoice</button>
												...
												<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal<?php echo $invoice;?>">view invoice</button>	
											</td>
										</tr>	
